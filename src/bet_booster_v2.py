        ...
        try:
            ...
            if 'goalsOu25' in odds:
                ...
                for aposta, value, prob_calc, prob_impl, odd in apostas_gols:
                    ...
                    if odd >= 1.7 and odd <= 2.1 and prob_calc > 40 and value_percent > 0:
                        tipo_recomendacao = "FORTE"
                    elif odd >= 1.7 and odd <= 3 and prob_calc > 40 and value_percent > 0:
                        tipo_recomendacao = "MODERADA"
                    elif odd >= 1.7 and odd <= 4 and prob_calc > 40 and value_percent > 0:
                        tipo_recomendacao = "ARRISCADA"
                    elif odd >= 1.7 and odd <= 5 and prob_calc > 40 and value_percent > 0:
                        tipo_recomendacao = "MUITO_ARRISCADA"
